...
export default function Portfolio() {
    return (
        <section id="portfolio" className="w-full md:h-screen">
            <div className="max-w-screen container mx-auto p-4 flex flex-col justify-center w-full h-full">
                <div className="pb-8">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
                    {portfolioData.map(({src, demo, code}) => (
                        <div key={src} className="shadow-md shadow-gray-600 rounded-lg">
                                <Image src={src} alt={src} className="rounded-md duration-200 hover:scale-105 w-full" width={390} height={100} />
